...
In 10 weeks create a light weight LLM chatbot that can be used to answer combat questions, spell descriptions and effects, NPC generation,
character generation, and virtual dice rolling. 
